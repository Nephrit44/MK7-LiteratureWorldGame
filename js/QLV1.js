const arrColletion = [
    ...
    },
    {
        ...
        questions__nonte: "Задачи литературы как вида искусства включают различные функции, которые влияют на восприятие произведения как автором, так и читателем.",
    },
]